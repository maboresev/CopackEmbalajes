<?php
	...
	$query = 'SELECT PEDIDO.NUM_PEDIDO, PEDIDO.FECHA_PEDIDO, PEDIDO.OID_C, LINEA_DE_PEDIDO.OID_P, '
		.'LINEA_DE_PEDIDO.NUM_PEDIDO, LINEA_DE_PEDIDO.CANTIDADPEDIDA, PRODUCTO.NOMBRE, PRODUCTO.OID_P '
		.'FROM PEDIDO, LINEA_DE_PEDIDO, PRODUCTO '
		.'WHERE '
			.'LINEA_DE_PEDIDO.OID_P = PRODUCTO.OID_P AND '
			.'PEDIDO.OID_P = LINEA_DE_PEDIDO.OID_P '
...
<main>
	 <nav>
		...
		<form method="get" action="mis_pedidos.php" class="consultaPaginada">
			<input id="PAG_NUM" name="PAG_NUM" type="hidden" value="<?php echo $pagina_seleccionada?>"/>
			Mostrando <?php echo $pag_tam ?> 
			entrada de <?php echo $total_registros?>
		</form>  
	</nav> 
