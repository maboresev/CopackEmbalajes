	 ...
	 <nav>
		...
		<p class="textoGen">Páginas:</p>
			...
			<?php }	else { ?>
						...
						<a class="nocurrent" href="almacen.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
		...
		<form method="get" action="almacen.php" class="consultaPaginada">
